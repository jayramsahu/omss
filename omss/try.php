...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Employment Portal v1.0</title>
  </head>
...
<div id="wrapper">
    <!-- Navigation -->
    <nav class="navbar navbar-fixed-top" role="navigation" style="background-color: #07142d;">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" style="color:whitesmoke;margin-top:5px;margin-left:10px;  " href="http://cijulenlinea.ucr.ac.cr/dev-users/">
                <h4>Employment Portal v1.0</h4>
            </a>
        </div>
        <!-- Top Menu Items -->
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav side-nav">
                <li>
                    <a href="#" style="color:white;" data-toggle="collapse" data-target="#submenu-1"><i class="fa fa-fw fa-search"></i> MENU 1 <i class="fa fa-fw fa-angle-down pull-right"></i></a>
                ...
                <li>
                    <a href="#" style="color:white;" data-toggle="collapse" data-target="#submenu-2"><i class="fa fa-fw fa-star"></i>  MENU 2 <i class="fa fa-fw fa-angle-down pull-right"></i></a>
                ...
                <li>
                    <a href="investigaciones/favoritas" style="color:white;"><i class="fa fa-fw fa-user-plus"></i>  MENU 3</a>
                </li>
                <li>
                    <a href="sugerencias" style="color:white;"><i class="fa fa-fw fa-paper-plane-o"></i> MENU 4</a>
                </li>
                <li>
                    <a href="faq" style="color:white;"><i class="fa fa-fw fa fa-question-circle"></i> MENU 5</a>
                </li>
            </ul>
        </div>
        <!-- /.navbar-collapse -->
